...
bool gBlinnPhong = false;	// Phong/Blinn-Phong control
...
static void init(GLFWwindow* window)
{
	...
	gShader.compileAndLink("lighting.vert", "pointLight.frag");
...
static void render_scene()
{
	...
	// use Phong/Blinn-Phong reflection model
	gShader.setUniform("uBlinnPhong", gBlinnPhong);
...
TwBar* create_UI(const std::string name)
{
	...
	TwAddVarRW(twBar, "Blinn-Phong", TW_TYPE_BOOLCPP, &gBlinnPhong, " group='Controls' ");
	...
	TwAddVarRW(twBar, "Quadratic", TW_TYPE_FLOAT, &gLight.att.z, " group='Light' min=0.0 max=2.0 step=0.01 ");
...
int main(void)
{
	...
	window = glfwCreateWindow(gWindowWidth, gWindowHeight, "Point Light", nullptr, nullptr);
